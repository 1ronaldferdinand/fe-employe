        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        <h4 class="m-4">Form Input Divisi</h4>
                        <hr>
                        <form @submit.prevent="submitForm">
                            ...
                            <div class="d-flex align-items-center justify-content-end m-4">
                                <button type="submit" class="btn btn-md btn-success shadow">SIMPAN</button>
                                <router-link :to="{name: 'divisions.index'}" class="btn btn-md btn-light border shadow mx-4">
                                    KEMBALI
                                </router-link>
                            </div>
                        </form>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post('http://127.0.0.1:8000/api/division/create', formData)
                .then(response => {
